angular.module('itunes').service('itunesService', function($http, $q){
  ...
  //You can return the http request or you can make your own promise in order to manipulate the data before you 
  //resolve it.
    ...
    this.getArtist = function(artist) {
        var deffered = $q.defer();
         $http({
          ...
          var parsedLength = parsedResponse.length;
          var responseArray = [];
  ...
  */
  ...
  //the iTunes data pushing into your new array objects that look like the above data. Make sure your method returns this 
  //finalized array of data. 
